			...
			<div className='cool-bg p-4 sm:p-6 md:p-8 lg:p-12 w-full  rounded-2xl border border-dark-300 overflow-x-auto'>
              ...
              <pre className='bg-gray-800 text-white p-4 sm:p-6 rounded-lg mb-4'>
                <code className='whitespace-pre break-words'>
					{`"game": "fortnite", "text": ${exampleRequestBody}`}
                </code>
              </pre>
						</div>
              ...
              <pre className='bg-gray-800 text-white p-4 sm:p-6 rounded-lg mb-4'>
                <code className='whitespace-pre break-words'>
                  {JSON.stringify({ games: ["fortnite", "beamng", "gd", "lol", "minecraft", "roblox", "valorant", "cs2", "repo"] }, null, 2)}
                </code>
              </pre>
						</div>
              ...
              <pre className='bg-gray-800 text-white p-4 sm:p-6 rounded-lg mb-4'>
                <code className='whitespace-pre break-words'>
                  {JSON.stringify({ error: "The body text or game is required." }, null, 2)}
                </code>
              </pre>
						</div>
